...
.log:active {
 ...
 <script type="text/javascript" src="http://cenpripower.com/online_timekeeping/scripts/jquery.min.js"></script> 
<script type="text/javascript" src="http://cenpripower.com/online_timekeeping/scripts/llqrcode.js"></script>
<script type="text/javascript" src="http://apis.google.com/js/plusone.js"></script>
<script type="text/javascript" src="http://cenpripower.com/online_timekeeping/scripts/webqr.js"></script>
                        ...
                        <tr>
                            <td valign="top" align="center" width="50%">
                                <table class="tsel" border="0">
                                    ...
                                    <tr>
                                        <td >
                                        <input type='text' name='empno' id='empno' class='empno' placeholder='Empoyee Number' required='required' autocomplete='off'>
                                        </td>
                                    </tr>
                                      <tr>
                                        <td >
                                        <input type='button' name='timein' value='Log In/Out' class='log' onclick="read()">
                                        </td>
                                    </tr>
                                </table>
                            </td>
