                                ...
                                <table  class="table table-bordered" width="100%" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px" width="2%">Others</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT DISTINCT personal_id, DATE_FORMAT(recorded_time, '%Y-%m-%d') as rec, login_type FROM timekeeping ";
                                            $url="";
                                            if(!empty($_GET)){
                                        ...
                                        <tr <?php echo (($cnt % 2 != 0 && empty($remarks)) ? "style='background-color:#FAAC9B'" : ""); ?>> 
                                           ...
                                           $x=1;
                                            while($fetch_rows = mysqli_fetch_array($count_rows)){  
                                                if($x<=8){?>
                                                <td><?php echo date('H:i:s', strtotime($fetch_rows['recorded_time'])) . " - " . $fetch_rows['login_type']; ?></td>
                                            <?php }
                                            $x++;
                                            } 
